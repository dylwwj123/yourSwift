...
extension PlaceholerTextView{
    ...
    private func setup(placeholder:String?,placeholderColor:UIColor?){
        ...
        textContainerInset = UIEdgeInsets(top: TextContainerInset().top, left: TextContainerInset().left, bottom: TextContainerInset().bottom, right: TextContainerInset().right)
//        print(plaleLabel)
